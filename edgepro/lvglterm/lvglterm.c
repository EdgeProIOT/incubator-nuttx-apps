/****************************************************************************
 * apps/edgepro/lvglterm/lvglterm.c
 *
...
/* LVGL Text Area Widgets for NSH Output */
 ...
 *   stdout and stderr to the LVGL Widgets.
 *
 * Input Parameters:
 *   None
 *
...
static int create_widgets(void)
{
  ...
  lv_style_set_text_font(&g_terminal_style, &lv_font_unscii_8);
 ...
 *   NSH Commands are entered through MX Keyboard. NSH Output is
